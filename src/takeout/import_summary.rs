use crate::takeout::{WatchHistoryEntry, WatchLaterEntry, YoutubeVideoId};
...
mod tests {
    ...
    fn summarizes_overlap_by_video_id() {
        let watch_later_entries = vec![
            WatchLaterEntry {
                video_id: YoutubeVideoId::new("shared-video".to_owned()).unwrap(),
                added_at: DateTime::parse_from_rfc3339("2026-03-26T17:55:54+00:00").unwrap(),
            },
            WatchLaterEntry {
                video_id: YoutubeVideoId::new("watch-later-only".to_owned()).unwrap(),
        ...
        let watch_history_entries = vec![
            ...
            WatchHistoryEntry {
                video_id: YoutubeVideoId::new("history-only".to_owned()).unwrap(),
